      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {news.map((article: News, index: number) => {
          return (
            ...
            >
              <div className="shadow-xl absolute top-0 left-0 py-2 px-4 backdrop-blur-sm bg-secondary/80 flex items-center justify-center gap-6 rounded-br-md text-xs">
                ...
                <span className="">
                  by <span className="font-bold">{article.user.name}</span>
                </span>
              </div>

              <div className="shadow-xl absolute bottom-0 left-0 right-0 py-2 px-4 backdrop-blur-sm bg-primary/50 cursor-pointer group">
