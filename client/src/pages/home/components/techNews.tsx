...
export function TechNews() {
  ...
  if (loading)
    return (
      <div className="animate-pulse w-full bg-vibrant-red rounded-xl p-4 md:p-8 grid grid-cols-1 xl:grid-cols-2 grid-auto-rows-[minmax(0, 220px)] gap-4 md:gap-8">
  ...
  return (
    <div className="w-full bg-vibrant-red rounded-xl p-4 md:p-8 grid grid-cols-1 xl:grid-cols-2 grid-auto-rows-[minmax(0, 220px)] gap-4 md:gap-8">
